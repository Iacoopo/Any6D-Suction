...
class Ho3dReader:
  ...
  def get_gt_mesh_diamter(self, model_dir='/home/miruware/ssd_4tb/dataset/ho3d/YCB_Video_Models'):
    gt_diameter = calc_pts_diameter(np.array(self.get_gt_mesh(model_dir=model_dir).vertices))
    return gt_diameter
